...
import { getDatabase, ref, onValue, set, update, remove, get, child } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-database.js";
...
export { db, ref, onValue, set, update, remove, get, child };
